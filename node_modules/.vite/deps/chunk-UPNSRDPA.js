...
import {
  BaseTile_default
} from "./chunk-72DZJRRO.js";
import {
  VectorTile_default
} from "./chunk-IGD25YNA.js";
import {
  Attributes,
...
} from "./chunk-FH33R4PM.js";
import {
  GeoJSON_default
} from "./chunk-67OTXZ7M.js";
import {
  Feature_default,
  MVT_default
} from "./chunk-OL3JUVAL.js";
import {
  VectorLayer_default,
  Vector_default
...
import {
  Fill_default
} from "./chunk-LVYKA657.js";
import {
  ImageLayer_default
} from "./chunk-KKUTS3CC.js";
import {
  ImageCanvas_default
...
var TileJSON = function(_super) {
  ...
  function TileJSON2(options) {
    var _this = this;
    var interpolate2 = options.imageSmoothing !== void 0 ? options.imageSmoothing : true;
    if (options.interpolate !== void 0) {
      interpolate2 = options.interpolate;
    }
...
var import_mapbox_to_css_font = __toESM(require_mapbox_to_css_font(), 1);
...
var renderFeature;
function getValue(layer2, layoutOrPaint, property, zoom, feature, functionCache) {
  ...
  if (!functions[property]) {
    ...
    var propertySpec = v8["".concat(layoutOrPaint, "_").concat(layer2.type)][property];
    if (value_1 === void 0) {
...
function evaluateFilter(layerId, filter2, feature, zoom, filterCache) {
  if (!filterCache) {
...
function stylefunction_default(olLayer, glStyle, source2, resolutions, spriteData, spriteImageUrl, getFonts2) {
  ...
  var styleFunction2 = function(feature, resolution) {
    ...
    var _loop_1 = function(i3, ii3) {
      ...
      if (!filter2 || evaluateFilter(layerId2, filter2, f, zoom, filterCache)) {
        ...
        if (type2 == 3 && (layer3.type == "fill" || layer3.type == "fill-extrusion")) {
          opacity = getValue(layer3, "paint", layer3.type + "-opacity", zoom, f, functionCache);
          if (layer3.type + "-pattern" in paint2) {
            var fillIcon = getValue(layer3, "paint", layer3.type + "-pattern", zoom, f, functionCache);
            if (fillIcon) {
            ...
            color2 = colorWithOpacity(getValue(layer3, "paint", layer3.type + "-color", zoom, f, functionCache), opacity);
            if (layer3.type + "-outline-color" in paint2) {
              strokeColor = colorWithOpacity(getValue(layer3, "paint", layer3.type + "-outline-color", zoom, f, functionCache), opacity);
            }
            if (!strokeColor) {
              strokeColor = color2;
            }
        ...
        if (type2 != 1 && layer3.type == "line") {
          color2 = !("line-pattern" in paint2) && "line-color" in paint2 ? colorWithOpacity(getValue(layer3, "paint", "line-color", zoom, f, functionCache), getValue(layer3, "paint", "line-opacity", zoom, f, functionCache)) : void 0;
          var width_1 = getValue(layer3, "paint", "line-width", zoom, f, functionCache);
          if (color2 && width_1 > 0) {
            ++stylesLength;
            style = styles[stylesLength];
            ...
            stroke = style.getStroke();
            stroke.setLineCap(getValue(layer3, "layout", "line-cap", zoom, f, functionCache));
            stroke.setLineJoin(getValue(layer3, "layout", "line-join", zoom, f, functionCache));
            stroke.setMiterLimit(getValue(layer3, "layout", "line-miter-limit", zoom, f, functionCache));
            stroke.setColor(color2);
            stroke.setWidth(width_1);
            stroke.setLineDash(paint2["line-dasharray"] ? getValue(layer3, "paint", "line-dasharray", zoom, f, functionCache).map(function(x) {
              return x * width_1;
            }) : null);
            style.setZIndex(index);
          }
        ...
        if ((type2 == 1 || type2 == 2) && "icon-image" in layout2) {
          var iconImage = getValue(layer3, "layout", "icon-image", zoom, f, functionCache);
          if (iconImage) {
            icon = typeof iconImage === "string" ? fromTemplate(iconImage, properties) : iconImage.toString();
            var styleGeom = void 0;
            if (spriteImage && spriteData && spriteData[icon]) {
              var iconRotationAlignment = getValue(layer3, "layout", "icon-rotation-alignment", zoom, f, functionCache);
              if (type2 == 2) {
                ...
                if (geom.getFlatMidpoint || geom.getFlatMidpoints) {
                  ...
                  if (size > 150) {
                    ...
                    var placement = getValue(layer3, "layout", "symbol-placement", zoom, f, functionCache);
              ...
              if (type2 !== 2 || styleGeom) {
                var iconSize = getValue(layer3, "layout", "icon-size", zoom, f, functionCache);
                var iconColor = paint2["icon-color"] !== void 0 ? getValue(layer3, "paint", "icon-color", zoom, f, functionCache) : null;
                if (!iconColor || iconColor.a !== 0) {
                  ...
                  if (!iconImg) {
                    ...
                    iconImg = new Icon_default({
                      ...
                      displacement: "icon-offset" in layout2 ? getValue(layer3, "layout", "icon-offset", zoom, f, functionCache).map(function(v) {
                ...
                if (iconImg) {
                  ...
                  iconImg.setRotation(placementAngle + deg2rad2(getValue(layer3, "layout", "icon-rotate", zoom, f, functionCache)));
                  iconImg.setOpacity(getValue(layer3, "paint", "icon-opacity", zoom, f, functionCache));
                  iconImg.setAnchor(anchor[getValue(layer3, "layout", "icon-anchor", zoom, f, functionCache)]);
        ...
        if (type2 == 1 && layer3.type === "circle") {
          ...
          var circleRadius = "circle-radius" in paint2 ? getValue(layer3, "paint", "circle-radius", zoom, f, functionCache) : 5;
          var circleStrokeColor = colorWithOpacity(getValue(layer3, "paint", "circle-stroke-color", zoom, f, functionCache), getValue(layer3, "paint", "circle-stroke-opacity", zoom, f, functionCache));
          var circleColor = colorWithOpacity(getValue(layer3, "paint", "circle-color", zoom, f, functionCache), getValue(layer3, "paint", "circle-opacity", zoom, f, functionCache));
          var circleStrokeWidth = getValue(layer3, "paint", "circle-stroke-width", zoom, f, functionCache);
        ...
        if ("text-field" in layout2) {
          textSize_1 = Math.round(getValue(layer3, "layout", "text-size", zoom, f, functionCache));
          var fontArray_1 = getValue(layer3, "layout", "text-font", zoom, f, functionCache);
          textLineHeight_1 = getValue(layer3, "layout", "text-line-height", zoom, f, functionCache);
          font = (0, import_mapbox_to_css_font.default)(getFonts2 ? getFonts2(fontArray_1) : fontArray_1, textSize_1, textLineHeight_1);
          letterSpacing_1 = getValue(layer3, "layout", "text-letter-spacing", zoom, f, functionCache);
          maxTextWidth_1 = getValue(layer3, "layout", "text-max-width", zoom, f, functionCache);
          var textField = getValue(layer3, "layout", "text-field", zoom, f, functionCache);
          if (typeof textField === "object" && textField.sections) {
            if (textField.sections.length === 1) {
              label = textField.toString();
            } else {
              label = textField.sections.reduce(function(acc, chunk, i4) {
                var fonts = chunk.fontStack ? chunk.fontStack.split(",") : fontArray_1;
                var chunkFont = (0, import_mapbox_to_css_font.default)(getFonts2 ? getFonts2(fonts) : fonts, textSize_1 * (chunk.scale || 1), textLineHeight_1);
                ...
                if (type2 == 2) {
                  acc.push(applyLetterSpacing(text2, letterSpacing_1), chunkFont);
                  return;
                }
                text2 = wrapText(text2, chunkFont, maxTextWidth_1, letterSpacing_1).split("\n");
                for (var i_2 = 0, ii_2 = text2.length; i_2 < ii_2; ++i_2) {
                  if (i_2 > 0) {
                    acc.push("\n", "");
                  }
                  acc.push(text2[i_2], chunkFont);
                }
                return acc;
              }, []);
            }
          ...
          opacity = getValue(layer3, "paint", "text-opacity", zoom, f, functionCache);
        }
        if (label && opacity && !skipLabel) {
          ...
          if (textTransform == "uppercase") {
            label = Array.isArray(label) ? label.map(function(t, i4) {
              return i4 % 2 ? t : t.toUpperCase();
            }) : label.toUpperCase();
          } else if (textTransform == "lowercase") {
            label = Array.isArray(label) ? label.map(function(t, i4) {
              return i4 % 2 ? t : t.toLowerCase();
            }) : label.toLowerCase();
          }
          var wrappedLabel = Array.isArray(label) ? label : type2 == 2 ? applyLetterSpacing(label, letterSpacing_1) : wrapText(label, font, maxTextWidth_1, letterSpacing_1);
          text.setText(wrappedLabel);
          text.setFont(font);
          text.setRotation(deg2rad2(getValue(layer3, "layout", "text-rotate", zoom, f, functionCache)));
          var textAnchor = getValue(layer3, "layout", "text-anchor", zoom, f, functionCache);
          var placement = hasImage || type2 == 1 ? "point" : getValue(layer3, "layout", "symbol-placement", zoom, f, functionCache);
          text.setPlacement(placement);
          text.setOverflow(placement === "point");
          var textHaloWidth = getValue(layer3, "paint", "text-halo-width", zoom, f, functionCache);
          var textOffset = getValue(layer3, "layout", "text-offset", zoom, f, functionCache);
          var textTranslate = getValue(layer3, "paint", "text-translate", zoom, f, functionCache);
          var vOffset = 0;
          var hOffset = 0;
          if (placement == "point") {
            ...
            var textRotationAlignment = getValue(layer3, "layout", "text-rotation-alignment", zoom, f, functionCache);
            text.setRotateWithView(textRotationAlignment == "map");
          } else {
            text.setMaxAngle(deg2rad2(getValue(layer3, "layout", "text-max-angle", zoom, f, functionCache)) * label.length / wrappedLabel.length);
            text.setTextAlign();
          ...
          textColor.setColor(colorWithOpacity(getValue(layer3, "paint", "text-color", zoom, f, functionCache), opacity));
          text.setFill(textColor);
          var haloColor = colorWithOpacity(getValue(layer3, "paint", "text-halo-color", zoom, f, functionCache), opacity);
          if (haloColor) {
          ...
          var textPadding = getValue(layer3, "layout", "text-padding", zoom, f, functionCache);
...
var import_mapbox_to_css_font2 = __toESM(require_mapbox_to_css_font());
var tilejsonCache = {};
...
function applyStyle(layer2, glStyle, source2, path, resolutions) {
  return new Promise(function(resolve, reject) {
    ...
    if (!(layer2 instanceof Vector_default || layer2 instanceof VectorTile_default)) {
    ...
    function onChange() {
      if (!style && (!glStyle.sprite || spriteData)) {
        ...
        if (!layer2.getStyle()) {
          reject(new Error("Nothing to show for source [".concat(source2, "]")));
        } else {
          resolve();
        }
      } else if (style) {
...
var emptyObj2 = {};
function setBackground(mapOrLayer, layer2) {
  var background = {
    id: layer2.id,
    type: layer2.type
  };
  ...
  function updateStyle(resolution) {
    ...
    var bg, opacity;
    if (paint2["background-color"] !== void 0) {
      bg = getValue(background, "paint", "background-color", zoom, emptyObj2, functionCache);
      if (element) {
        element.style.background = Color.parse(bg).toString();
      }
    }
    if (paint2["background-opacity"] !== void 0) {
      opacity = getValue(background, "paint", "background-opacity", zoom, emptyObj2, functionCache);
      if (element) {
        element.style.opacity = opacity;
      }
    }
    if (layout2.visibility == "none") {
      if (element) {
  ...
  return new Promise(function(resolve) {
    var key = tilejson.on("change", function() {
      ...
      if (state === "ready") {
        ...
        if (source2 === void 0) {
          source2 = new VectorTile_default2({
...
var MapboxVectorLayer = function(_super) {
  ...
  function MapboxVectorLayer2(options) {
    ...
    _this.setMaxResolutionFromTileGrid_ = options.maxResolution === void 0 && options.minZoom === void 0;
  ...
  MapboxVectorLayer2.prototype.onStyleLoad = function(style, styleUrl) {
    var _this = this;
    var sourceId;
    ...
    if (styleSource.url && styleSource.url.indexOf("mapbox://") === 0) {
      source2.setUrl(normalizeSourceUrl(styleSource.url, this.accessToken, this.accessTokenParam_, styleUrl));
      applyStyle(this, style, sourceIdOrLayersList).then(function() {
        _this.configureSource(source2, style);
      }).catch(function(error2) {
        _this.handleError(error2);
      });
    } else {
      ...
      setupVectorSource(styleSource, styleSource.url ? normalizeSourceUrl(styleSource.url, this.accessToken, this.accessTokenParam_, styleUrl) : void 0).then(function(source3) {
        applyStyle(_this, style, sourceIdOrLayersList).then(function() {
          _this.configureSource(source3, style);
        }).catch(function(error2) {
          _this.configureSource(source3, style);
          _this.handleError(error2);
        });
  ...
  MapboxVectorLayer2.prototype.configureSource = function(source2, style) {
    var targetSource = this.getSource();
    if (source2 !== targetSource) {
      targetSource.setAttributions(source2.getAttributions());
      targetSource.setTileUrlFunction(source2.getTileUrlFunction());
      targetSource.setTileLoadFunction(source2.getTileLoadFunction());
      targetSource.tileGrid = source2.tileGrid;
    }
    ...
    targetSource.setState(State_default.READY);
  };
...
var CanvasVectorImageLayerRenderer = function(_super) {
  __extends4(CanvasVectorImageLayerRenderer2, _super);
...
var VectorImageLayer = function(_super) {
  __extends5(VectorImageLayer2, _super);
...
var WebGLTileLayer = function(_super) {
  ...
  WebGLTileLayer2.prototype.getSources = function(extent, resolution) {
    var source2 = this.getSource();
    return this.sources_ ? typeof this.sources_ === "function" ? this.sources_(extent, resolution) : this.sources_ : source2 ? [source2] : [];
  };
  WebGLTileLayer2.prototype.getRenderSource = function() {
    return this.renderedSource_ || this.getSource();
  };
  WebGLTileLayer2.prototype.getSourceState = function() {
    var source2 = this.getRenderSource();
    return source2 ? source2.getState() : State_default.UNDEFINED;
  };
  ...
  WebGLTileLayer2.prototype.getSourceBandCount_ = function() {
    var source2 = this.getSource();
    return source2 && "bandCount" in source2 ? source2.bandCount : 4;
  };
  ...
  WebGLTileLayer2.prototype.renderSources = function(frameState, sources2) {
    var layerRenderer = this.getRenderer();
    var canvas;
    for (var i = 0, ii = sources2.length; i < ii; ++i) {
  ...
  WebGLTileLayer2.prototype.render = function(frameState, target) {
    ...
    this.rendered = true;
    var viewState = frameState.viewState;
    var sources2 = this.getSources(frameState.extent, viewState.resolution);
    var ready = true;
    var _loop_2 = function(i2, ii2) {
      var source2 = sources2[i2];
      var sourceState = source2.getState();
      if (sourceState == State_default.LOADING) {
        var onChange_1 = function() {
          if (source2.getState() == State_default.READY) {
            source2.removeEventListener("change", onChange_1);
            _this.changed();
          }
        };
        source2.addEventListener("change", onChange_1);
      }
    ...
    var canvas = this.renderSources(frameState, sources2);
    if (this.getRenderer().renderComplete && ready) {
      this.renderedResolution_ = viewState.resolution;
      return canvas;
    }
    if (this.renderedResolution_ > 0.5 * viewState.resolution) {
      var altSources = this.getSources(frameState.extent, this.renderedResolution_).filter(function(source2) {
        return !sources2.includes(source2);
      });
...
//# sourceMappingURL=chunk-UPNSRDPA.js.map
