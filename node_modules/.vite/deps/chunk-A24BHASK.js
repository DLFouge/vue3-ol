...
var DragBoxEvent = function(_super) {
  __extends5(DragBoxEvent2, _super);
...
var KeyboardPan = function(_super) {
  __extends7(KeyboardPan2, _super);
...
var KeyboardZoom = function(_super) {
  __extends8(KeyboardZoom2, _super);
...
var MouseWheelZoom = function(_super) {
  __extends9(MouseWheelZoom2, _super);
...
var PinchRotate = function(_super) {
  __extends10(PinchRotate2, _super);
...
var DragAndDropEvent = function(_super) {
  __extends12(DragAndDropEvent2, _super);
...
var DragAndDrop = function(_super) {
  __extends12(DragAndDrop2, _super);
...
var DragRotateAndZoom = function(_super) {
  __extends13(DragRotateAndZoom2, _super);
...
var ExtentEvent = function(_super) {
  __extends14(ExtentEvent2, _super);
...
var ModifyEvent = function(_super) {
  __extends15(ModifyEvent2, _super);
...
var SelectEvent = function(_super) {
  __extends16(SelectEvent2, _super);
  ...
  Snap2.prototype.snapTo = function(pixel, pixelCoordinate, map) {
    ...
    if (this.vertex_) {
      for (var i = 0; i < segmentsLength; ++i) {
        ...
        if (segmentData.feature.getGeometry().getType() !== GeometryType_default.CIRCLE) {
...
var TranslateEvent = function(_super) {
  __extends18(TranslateEvent2, _super);
...
//# sourceMappingURL=chunk-A24BHASK.js.map
