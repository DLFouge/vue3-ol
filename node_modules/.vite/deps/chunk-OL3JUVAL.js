  ...
  MVT2.prototype.createFeature_ = function(pbf, rawFeature, options) {
    ...
    if (this.featureClass_ === Feature_default3) {
      ...
      if (geometryType == GeometryType_default.POLYGON) {
        ...
        geom = endss.length > 1 ? new MultiPolygon_default(flatCoordinates, GeometryLayout_default.XY, endss) : new Polygon_default(flatCoordinates, GeometryLayout_default.XY, ends);
      } else {
...
//# sourceMappingURL=chunk-OL3JUVAL.js.map
