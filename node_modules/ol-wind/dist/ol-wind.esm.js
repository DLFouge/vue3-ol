...
import { makeScale, makeInverse, toString as toString$1, create, setFromArray, apply } from 'ol/transform';
import { getIntersection, isEmpty, containsExtent, intersects, containsCoordinate } from 'ol/extent';
...
var Render = /** @class */ (function () {
    ...
    Render.prototype.setData = function (field) {
        var _this = this;
        Object.keys(this.executors).forEach(function (key) {
            var wind = _this.executors[key];
            if (wind) {
    ...
    Render.prototype.repeatWorld = function (coordinates, pixelCoordinates, transform) {
        var pixel;
        if (pixelCoordinates && equals(transform, this.renderedTransform_)) {
            ...
            pixel = transform2D(coordinates, 0, coordinates.length, 2, transform, pixelCoordinates);
